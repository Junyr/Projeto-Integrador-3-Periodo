...
public class Usuario {
    ...
    public static boolean ValidarCPF(String CPF){
        ...
        if(CPF.matches("(\\d)\\1{10}") || !CPF.matches("\\d{11}$")) return false;
        ...
        // Reduzo o resto da divisisão por 11 para poder achar o primeiro digito.
         ...
         * seria se o numero da variavel PrimeiroDigito é igual ao numero da posição da variavel CPF.
